...
- Active research goal contracts live under goal-scoped folders in `experiments/goals/`. For current Mario Level1-1 work, read `experiments/goals/mario-level1-100of100/goal.yaml` before choosing specs, seeds, caps, metrics, or promotion criteria.
