# Mario World 2-1 100/100 Goal

This folder is the durable capsule for the active `Level2-1`
research objective.

Primary optimization metric: peak
`train/info/level_complete/rate/min/last`. For this single-level goal it should
match the Level2-1 source rate once the rolling source window is full; external
...
source-attempt success window for the single Level2-1 start state.
